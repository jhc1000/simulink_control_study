classdef plotting_tools
    ...
    methods(Static)
        ...
        function fig = plot_robot_space(self)
            ...
            P3 = Polyhedron(((self.p.s_ej(:,1)+self.p.s_ej(:,2))./2).' + 0.0005.*self.ascender_force_polytope1);
        ...
        function self = plot_ascender_force_polytopes(self)
            ...
            P = Polyhedron(self.ascender_force_polytope1);
            ...
            view(45,30);
            % xlabel("F_x [N]");ylabel("\tau_y [Nm]");zlabel("F_z [N]");
            xlabel("F_x [N]");ylabel("F_y [N]");zlabel("F_z [N]");
