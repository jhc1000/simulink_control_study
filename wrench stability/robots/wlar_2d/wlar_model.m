classdef wlar_model
    ...
    methods
        function self = init(~, self)
            ...
            self.LF_tau_lim = [96.0 150.0 144.0];  % HR, HP, K
            self.LH_tau_lim = [96.0 150.0 144.0];  % HR, HP, K
            self.RF_tau_lim = [96.0 150.0 144.0];  % HR, HP, K
            self.RH_tau_lim = [96.0 150.0 144.0];  % HR, HP, K
