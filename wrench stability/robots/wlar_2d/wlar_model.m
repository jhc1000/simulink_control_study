classdef wlar_model
    properties
        ...
        LF_tau_lim = [120.0 150.0 120.0];  % HR, HP, K
        LH_tau_lim = [120.0 150.0 120.0];  % HR, HP, K
        RF_tau_lim = [120.0 150.0 120.0];  % HR, HP, K
        RH_tau_lim = [120.0 150.0 120.0];  % HR, HP, K
    ...
    methods
        function self = init(~, self)
            ...
            self.ASC_L_tension_lim = [82.0 400.0];  % min, max 
            self.ASC_R_tension_lim = [82.0 400.0];  % min, max
