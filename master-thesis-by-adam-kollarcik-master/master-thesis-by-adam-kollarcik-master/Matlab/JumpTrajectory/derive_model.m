...
syms xw yw th0 th1 th2 th4 th3 dxw dyw dth0 dth1 dth2 dth3 dth4 dqxw dqyw dq0  dq1 dq2 dq3 dq4  vx vy v1 v2 v3 dv1 dv2 dv3 t kspring k_ang u0 u3 real 
syms  qxw(t) qyw(t) q0(t) q1(t) q2(t) q3(t) q4(t)
v = [vx;vy;v1;v2;v3];
dv = [dv1;dv2;dv3];
th = [xw;yw;th0;th1;th2;th3;th4];
q = [qxw;qyw;q0;q1;q2;q3;q4];
dq = [dqxw;dqyw;dq0;dq1;dq2;dq3;dq4];
q_diffs = [diff(qxw, t);diff(qyw, t);diff(q0, t);diff(q1, t);diff(q2, t);diff(q3, t);diff(q4, t)];
dth = [dxw;dyw;dth0;dth1;dth2;dth3;dth4];
[x0,x1,x12,x2,x23,x14,x4,x34,x3,x45] = get_points(th0,th1,th2,th3,th4,r,r3,ang_3,xw,yw,l1c,l11,l2c,l4c,l3,a_body,b_body);
...
Dw0 = diag([0 0 I0 0 0 0 0]);
Dw1 = diag([0 0 0 I1 0 0 0]);
Dw2 = [zeros(7,3) [zeros(3,3);[ones(2,2)*I2 zeros(2,1)]; zeros(2,3)] zeros(7,1)];
Dw3 = [zeros(7,3) [zeros(3,3); ones(3,3)*I3; zeros(1,3)] zeros(7,1)];
Dw4 = [zeros(7,3) [zeros(3,4); I4 0 0 I4 ; 0 0 0 0 ; 0 0 0 0; I4 0 0 I4]];
...
matlabFunction(Mg,Cg,psig,Bg,Jg,'File','get_matrices_LIGHT','Vars',{[vx;vy;v1;v2;v3;xw;yw; th0; th1; th2; th3; th4],[kspring;k_ang]},'Optimize',true,'Outputs',{'M', 'C', 'N', 'B', 'J'});
matlabFunction(phi,'File','ground_const','Vars',{[vx;vy;v1;v2;v3;xw;yw; th0; th1; th2; th3; th4]},'Optimize',true,'Outputs',{'phi'});
matlabFunction(Jg,'File','const_jacobian','Vars',{[vx;vy;v1;v2;v3;xw;yw; th0; th1; th2; th3; th4]},'Optimize',true,'Outputs',{'J'});
% matlabFunction(([fopt;0;0]-[zeros(3,1);lhs(g1)]),'File','eq_search_fixed_damping','Vars',{[th1; th2; th3;th4;kspring;k_ang;u0;u3]});
