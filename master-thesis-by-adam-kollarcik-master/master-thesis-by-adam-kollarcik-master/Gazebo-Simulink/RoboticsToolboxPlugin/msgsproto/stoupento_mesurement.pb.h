...
class StoupentoMesurement : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:stoupentoPlugin_msgs.msgs.StoupentoMesurement) */ {
 public:
  ...
  static const int kLinearAccFieldNumber = 25;
  private:
  const ::gazebo::msgs::Vector3d& _internal_linear_acc() const;
  public:
  ...
  static const int kAngularVelFieldNumber = 26;
  private:
  const ::gazebo::msgs::Vector3d& _internal_angular_vel() const;
  public:
 ...
 private:
  ...
  void set_has_linear_acc();
  void clear_has_linear_acc();
...
inline const ::gazebo::msgs::Vector3d& StoupentoMesurement::_internal_linear_acc() const {
  return *linear_acc_;
}
inline const ::gazebo::msgs::Vector3d& StoupentoMesurement::linear_acc() const {
  const ::gazebo::msgs::Vector3d* p = linear_acc_;
...
inline void StoupentoMesurement::set_allocated_linear_acc(::gazebo::msgs::Vector3d* linear_acc) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(linear_acc_);
  }
  if (linear_acc) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      linear_acc = ::google::protobuf::internal::GetOwnedMessage(
...
inline const ::gazebo::msgs::Vector3d& StoupentoMesurement::_internal_angular_vel() const {
  return *angular_vel_;
}
inline const ::gazebo::msgs::Vector3d& StoupentoMesurement::angular_vel() const {
  const ::gazebo::msgs::Vector3d* p = angular_vel_;
